...
const Main = ({ imagen, slogan }) => {
  ...
  return (
    <div className="main">
      ...
      <img src={imagen.url} />
      <button
        onClick={() => setContadorVisitas(contadorVisitas + 1)}
        className="btn-visitas"
      >
        Actualizar visitas
      </button>
      <p>
        El # de visitas es: <b> {contadorVisitas}</b>
      </p>
      <p>
        Nombre de marca: <b> {nameBrand} </b>
      </p>
      .
      <input
        className="brand"
        placeholder="ingresa el brand"
